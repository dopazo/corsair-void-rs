...
use windows::Win32::Media::Audio::{
    eCapture, eRender, IAudioCaptureClient, IAudioClient, IAudioRenderClient, IMMDeviceEnumerator,
...
fn main() {
    unsafe {
        ...
        let capture_format_ptr: *mut WAVEFORMATEX =
            capture_client.GetMixFormat().expect("mix format capture");
        ...
        println!(
            "  Format: {} Hz, {} ch, {} bits, align={}, tag={}, cbSize={}",
        ...
        let render_format_ptr: *mut WAVEFORMATEX =
            render_client.GetMixFormat().expect("mix format render");
            ...
            while packet_size > 0 {
                ...
                if num_frames > 0 {
                    ...
                    if total_packets % 50 == 0 {
                        ...
                        print!(
                            "\r  [{:.0}s] in_peak={:.4}, out_peak={:.4}, wrote={}    ",
